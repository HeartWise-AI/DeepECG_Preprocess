...
def plot_a_lead(data_set,save_path,row_num=1):
    ...
    plt.savefig(os.path.join(save_path,"ECG_{}_{}_{}.jpg".format(data_set['RestingECG_PatientDemographics_PatientID'].iloc[row_num],data_set['RestingECG_TestDemographics_AcquisitionDate'].iloc[row_num], data_set['RestingECG_TestDemographics_AcquisitionTime'].iloc[row_num])))
